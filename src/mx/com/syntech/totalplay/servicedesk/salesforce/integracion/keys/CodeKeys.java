...
import com.totalplay.syntech.integracion.sdm.soainfra.wssdm.keys.*;
...
public class CodeKeys {
    ...
    public static final String CODE_130_VALOR_INCORRECTO = "130";
    public static final String CODE_140_PARAMETROS_FALTANTES = "140";
    public static final String CODE_150_INFORMACIONNO_ENCONTRADA = "150";
    ...
    public static final String CODE_610_WSSF_ERROR = "610";
    public static final String CODE_620_WSSF_MALURL = "620";
    public static final String CODE_630_WSSF_IOERROR = "630";
    
    public static final String CODE_700_JAR_EXCEPTION = "700";
    public static final String CODE_700_JAR_THROWABLE = "710";
